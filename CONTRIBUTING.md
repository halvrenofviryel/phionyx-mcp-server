# Contributing to `phionyx-mcp-server`

`phionyx-mcp-server` is an MCP trust boundary — descriptor hashing, signed RGE v0.2 envelopes, and an audit chain over third-party MCP tool calls. It is **alpha / experimental**. Contributions, independent
