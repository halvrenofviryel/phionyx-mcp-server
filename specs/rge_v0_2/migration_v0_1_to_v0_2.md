...
| `subagent_chain` block | — | optional, reserved/active | New in v0.2. `status: "reserved-for-v0.6.0-f5"` until F5 ships. |
...
| `subagent_chain` | — | optional block | Omit entirely when migrating; F5 populates from v0.6.0. |
